...
const Footer = () => {
	return (
		<footer className='flex flex-col items-center justify-center gap-14 px-32 py-16 md:py-20 lg:py-32'>
			...
			<div className='flex flex-row items-center gap-7'>
				<div>
					<svg
						...
						aria-hidden={true}
						focusable={false}
						className='fill-davysGrey hover:cursor-pointer hover:fill-darkPurple'
						viewBox='0 0 20 20'>
